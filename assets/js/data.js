...
const AWARDS = [
  ...
  },
  {
    ...
    org: "中国银保监会（微众银行）",
    date: "2018",
    desc: "微众银行「基于分布式架构的同城多中心多活架构」荣获中国银保监会 2018 年度银行业信息科技风险管理课题研究成果「一类成果奖」（部级，国家科技成果库 2019 年入库）。陈广胜位列成果完成人之一，与马智涛、卢道和、杨军等 17 人共同完成；研究期 2016–2018，在两地三中心基础上实现同城任一数据中心故障不影响业务，达成同城 RPO=0、RTO≈0，是银行级高可用的标杆实践。",
