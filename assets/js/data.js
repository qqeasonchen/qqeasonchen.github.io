...
const PATENTS = [
  ...
  },
  {
    title: "一种日志数据采集方法及装置",
    number: "CN110263011A",
    date: "2019 申请 · 2019 公布",
    inventors: "卢道和；杨军；陈广胜；陈翼",
    assignee: "深圳前海微众银行股份有限公司",
    status: "发明专利",
    abstract: "采集各业务系统日志数据时，通过代理程序按预设策略将日志统一上报至消息中间件，再由日志系统消费存储，实现分布式环境下日志的标准化采集与集中管理，降低业务系统日志采集的侵入性与运维成本。",
    url: "https://patents.google.com/patent/CN110263011A/zh"
  },
  {
    title: "日志分析方法、设备和计算机可读存储介质",
    number: "CN107391746A",
    date: "2017 申请 · 2017 公布",
    inventors: "卢道和；杨军；陈广胜；陈翼",
    assignee: "深圳前海微众银行股份有限公司",
    status: "发明专利",
    abstract: "对采集的分布式系统日志进行结构化解析与关联分析，识别异常模式并定位故障根因，提升金融级系统日志分析的效率与准确性。",
    url: "https://patents.google.com/patent/CN107391746A/zh"
  },
  {
    title: "异常定位方法、装置、系统与计算机可读存储介质",
    number: "CN111538616A",
    date: "2020 申请 · 2020 公布",
    inventors: "卢道和；杨军；陈广胜；陈翼",
    assignee: "深圳前海微众银行股份有限公司",
    status: "发明专利",
    abstract: "基于分布式链路追踪与日志关联，自动定位系统异常发生的节点与服务，结合调用链还原异常传播路径，缩短故障定位时间。",
    url: "https://patents.google.com/patent/CN111538616A/zh"
  },
  {
    title: "一种服务熔断方法、装置及消息中间件",
    number: "CN110377434A",
    date: "2019 申请 · 2019 公布",
    inventors: "卢道和；杨军；陈广胜；熊梦飞；梁炜强",
    assignee: "深圳前海微众银行股份有限公司",
    status: "发明专利（含 PCT：WO2021000693A1）",
    abstract: "在消息中间件层面监测下游服务健康状态，当依赖服务异常时自动触发熔断并将消息路由至备用服务，避免故障级联扩散，保障金融级消息总线的可用性。",
    url: "https://patents.google.com/patent/CN110377434A/zh"
  },
  {
    title: "消息队列的分配方法、装置、设备及计算机可读存储介质",
    number: "CN110781015A",
    date: "2019 申请 · 2020 公布",
    inventors: "卢道和；杨军；陈广胜；熊梦飞；梁炜强；贺繁",
    assignee: "深圳前海微众银行股份有限公司",
    status: "发明专利",
    abstract: "根据业务灰度发布需求动态分配消息队列，使新旧版本服务基于独立队列并行消费，实现消息中间件层面的平滑灰度发布与流量隔离。",
    url: "https://patents.google.com/patent/CN110781015A/zh"
  },
  {
    title: "一种电子邮件的发送方法及装置",
    number: "CN111049740B",
    date: "2019 申请 · 2023 授权",
    inventors: "何舢；卢道和；杨军；陈广胜",
    assignee: "深圳前海微众银行股份有限公司",
    status: "已授权",
    abstract: "针对金融业务通知邮件的发送场景，提供邮件发送方法与装置，支持模板化内容与多通道发送，提升批量邮件投递的可靠性与可追溯性。",
    url: "https://patents.google.com/patent/CN111049740B/zh"
  },
  {
    title: "一种日志处理方法、设备及存储介质",
    number: "CN112650599B",
    date: "2020 申请 · 授权",
    inventors: "李慧敏；陈翼；陈广胜；杨军；卢道和",
    assignee: "深圳前海微众银行股份有限公司",
    status: "已授权",
    abstract: "对分布式系统日志进行统一处理与索引构建，支持按维度快速检索，降低海量日志的存储与查询成本，提升运维排障效率。",
    url: "https://patents.google.com/patent/CN112650599B/zh"
  },
  {
    title: "消息传输方法、装置、设备及存储介质",
    number: "CN112954007A",
    date: "2021 申请 · 2021 公布",
    inventors: "卢道和；杨军；陈广胜；梁炜强；熊梦飞",
    assignee: "深圳前海微众银行股份有限公司",
    status: "发明专利申请",
    abstract: "消息服务端接收客户端经消息中间件发来的请求并生成响应，附加客户端标识后经由响应主题回传，由中间件按标识精准投递，减少为每个客户端建立独立队列的资源消耗。",
    url: "https://patents.google.com/patent/CN112954007A/zh"
  },
  {
    title: "一种业务系统异常监控方法及装置",
    number: "CN113094238A",
    date: "2021 申请 · 2021 公布",
    inventors: "陈翼；卢道和；杨军；陈广胜",
    assignee: "深圳前海微众银行股份有限公司",
    status: "发明专利申请",
    abstract: "在业务系统部署发布脚本，依据业务进程运行状态自动加载代理埋点程序包，实现自动化埋点与异常监控，降低埋点工作周期与难度，快速定位异常根因。",
    url: "https://patents.google.com/patent/CN113094238A/zh"
  },
  {
    title: "一种系统异常告警处理方法及装置",
    number: "CN110275815A",
    date: "2019 申请 · 2019 公布",
    inventors: "卢道和；杨军；汪晓雪；陈翼；程志峰；李兴龙；胡仲臣；李慧敏；周佳振；朱嘉伟；陈刚；罗海湾；李勋棋；郭英亚；陈广胜；周琪",
    assignee: "深圳前海微众银行股份有限公司",
    status: "发明专利",
    abstract: "对分布式系统运行指标进行实时监测，在异常达到阈值时生成分级告警并通知相应处理方，提升异常处理的时效性与事前预警、预防能力。",
    url: "https://patents.google.com/patent/CN110275815A/zh"
  },
  {
    title: "数据一致性修复方法、系统、装置及设备",
    number: "CN112860708B",
    date: "2021 申请 · 2024 授权",
    inventors: "陈一鎏；卢道和；杨军；陈广胜；熊梦飞；梁炜强；李慧敏；梁荣华",
    assignee: "深圳前海微众银行股份有限公司",
    status: "已授权",
    abstract: "服务端向多个名字中心发送数据请求，获取各名字中心的数据版本信息与标识，比对发现不一致时自动触发数据一致性修复，保障分布式名字路由服务的数据准确。",
    url: "https://patents.google.com/patent/CN112860708B/zh"
  },
  {
    title: "接口测试案例的生成方法、装置、设备及存储介质",
    number: "CN110334021B",
    date: "2019 申请 · 2023 授权",
    inventors: "方镇举；翁玉萍；周杰；卢道和；韩海燕；杨军；陈广胜 等",
    assignee: "深圳前海微众银行股份有限公司",
    status: "已授权",
    abstract: "基于接口定义自动生成测试案例，覆盖正常与异常调用路径，提升金融系统接口测试的自动化程度与覆盖率，降低人工编写测试案例的成本。",
    url: "https://patents.google.com/patent/CN110334021B/zh"
  },
  {
    title: "版本管理方法、装置、设备及计算机可读存储介质",
    number: "CN110222500A",
    date: "2019 申请 · 2019 公布",
    inventors: "李慧敏；熊梦飞；梁炜强；陈广胜；杨军；卢道和",
    assignee: "深圳前海微众银行股份有限公司",
    status: "发明专利",
    abstract: "消息中间件服务端在收到客户端心跳请求时识别其中的客户端版本信息，与预设配置匹配后决定是否响应其消息业务，实现对客户端版本的精细控制，降低版本维护成本与风险。",
    url: "https://patents.google.com/patent/CN110222500A/zh"
  }
];
...
const AWARDS = [
  {
    title: "中国人民银行 2019 年度银行科技发展奖一等奖 · 国产化芯片技术在银行落地应用",
